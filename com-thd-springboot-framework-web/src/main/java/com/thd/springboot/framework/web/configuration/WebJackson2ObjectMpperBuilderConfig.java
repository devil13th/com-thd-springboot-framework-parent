...
import com.thd.springboot.framework.web.jsondeserializers.StringXssDeserializer;
...
@Configuration
public class WebJackson2ObjectMpperBuilderConfig {
    @Bean
    public Jackson2ObjectMapperBuilderCustomizer customJackson() {
        return jacksonObjectMapperBuilder -> {
            ...
            jacksonObjectMapperBuilder.modules(javaTimeModule,javaTimeModuleForLocalDate);
