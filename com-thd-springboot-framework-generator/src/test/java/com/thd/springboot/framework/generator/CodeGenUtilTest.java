...
//
//	@Test
//	public void testmakeCodeByTemplateToMybatis(){
//		CodeGenUtilImpl u = new CodeGenUtilImpl();
//		try{
//			String cfgXmlConfigPath = "D:\\devil13th\\github\\com-thd-springboot-framework-parent\\com-thd-springboot-framework-generator\\src\\main\\java\\com\\thd\\springboot\\framework\\generator\\cfg\\mybatis.xml";
//			String templateFolderPath = "D:\\devil13th\\github\\com-thd-springboot-framework-parent\\com-thd-springboot-framework-generator\\src\\main\\resources\\template\\mybatis\\";
//			String targetFolder = "D://deleteme//cg//";
//
//			CodeGenConfig cfg = u.xmlToConfig(cfgXmlConfigPath);
//			//生成pojo
//			u.makeCodeByTemplate(cfg,templateFolderPath + "template.ftl",targetFolder + cfg.getTableCodeForClass() + ".java");
//
//		}catch(Exception e){
//			e.printStackTrace();
//		}
